...
class LinfoOutput {
	...
	*/
	...
	<link href="'.LINFO_URL.'layout/'.$theme_css.'" rel="stylesheet">'.( $show_icons ? '
	<link href="'.LINFO_URL.'layout/icons.css" rel="stylesheet">' : ''
	).'
	<script src="'.LINFO_URL.'layout/scripts.min.js"></script>
	
	<!--[if lt IE 8]>
	<link href="'.LINFO_URL.'layout/old_ie.css" type="text/css" rel="stylesheet">
	<![endif]-->
	<link rel="stylesheet" type="text/css" href="'.LINFO_URL.'layout/mobile.css" media="screen and (max-width: 640px)">
